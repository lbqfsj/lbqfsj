...
const hupu = document.querySelector('.hupu')
const qq = document.querySelector('.qq')
const button = document.querySelector('.button')
const kk = document.getElementsByClassName('kkk')
...
hupu.addEventListener('click',(e)=>{
    e.preventDefault();
    mask.classList.remove('isShow');
    kk[0].src = './assets/img/j1.jpg'
})
